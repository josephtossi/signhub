...
var AuditController = function () {
    var _classDecorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Controller)("audit")];
    ...
    var AuditController = _classThis = /** @class */ (function () {
        ...
        AuditController_1.prototype.list = function (envelopeId) {
    ...
    (function () {
        ...
        _list_decorators = [(0, common_1.Get)("envelope/:envelopeId")];
