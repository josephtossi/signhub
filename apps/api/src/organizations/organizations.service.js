...
var OrganizationsService = function () {
    ...
    var OrganizationsService = _classThis = /** @class */ (function () {
        function OrganizationsService_1(prisma) {
            this.prisma = prisma;
        }
        OrganizationsService_1.prototype.create = function (userId, name) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.organization.create({
                            data: {
                                name: name,
                                users: {
                                    create: {
        ...
        OrganizationsService_1.prototype.listForUser = function (userId) {
