...
var OrganizationsController = function () {
    var _classDecorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Controller)("organizations")];
    ...
    var OrganizationsController = _classThis = /** @class */ (function () {
        ...
        OrganizationsController_1.prototype.create = function (userId, dto) {
            return this.organizationsService.create(userId, dto.name);
        };
        OrganizationsController_1.prototype.list = function (userId) {
