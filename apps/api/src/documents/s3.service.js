...
var S3Service = function () {
    ...
    var S3Service = _classThis = /** @class */ (function () {
        ...
        S3Service_1.prototype.upload = function (key, body, contentType) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [2 /*return*/, { key: key, bucket: this.bucket }];
                    }
                });
            });
        };
        S3Service_1.prototype.getObject = function (key) {
            return __awaiter(this, void 0, void 0, function () {
                var output, bytes;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.client.send(new client_s3_1.GetObjectCommand({
                                Bucket: this.bucket,
                                Key: key
                            }))];
                        case 1:
                            output = _b.sent();
                            return [4 /*yield*/, ((_a = output.Body) === null || _a === void 0 ? void 0 : _a.transformToByteArray())];
                        case 2:
                            bytes = _b.sent();
                            return [2 /*return*/, {
